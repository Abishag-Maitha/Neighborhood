...
class TestProfile(TestCase):
    def setUp(self):
        ...
        self.profile_test = Profile(id=1, name='loca', profile_picture='default.jpg', bio='my bio',user=self.user)
...
class TestPost(TestCase):
    def setUp(self):
        self.profile_test = Profile(name='abishag', user=User(username='pendo'))
